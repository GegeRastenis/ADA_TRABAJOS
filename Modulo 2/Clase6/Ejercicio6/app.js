...
rl.setPrompt('Por favor ingrese una frase o bien escriba "salir" para finalizar el programa: '); 
rl.prompt(); 

rl.on('line', (input) =>{
    if(input === 'salir'){
        console.log("Gracias por haber utilizado este programa"); 
        rl.close(); 
    }else{
    let convertirMayuscula = input.toLocaleUpperCase(); 
