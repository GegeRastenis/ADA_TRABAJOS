...
rl.question('Podrias ingresar un primer numero? ', (num1)=>{
    rl.question('Podrias ingresar un segundo numero? ', (num2) =>{
    const suma = parseFloat (num1) + parseFloat (num2); 
    console.log(`La suma de ambos numeros da un total de: ${suma}`); 
    rl.close()
    }); 
}); 

rl.on('close', ()=>{
    console.log('Gracias por sumar junto a nosotros :)'); 
    process.exit(0); 
}); 