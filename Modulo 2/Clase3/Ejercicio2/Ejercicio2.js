...
const actualizarTemporada = (idSerie, nuevasTemporadas) =>{
    const series = leerSeries()
...
//registrarSerie("La Casa de Papel", 5)
//registrarSerie("Friends", 10)
//registrarSerie("Orange is the New Black", 6)
//registrarSerie("The Office", 5)
//listarSeries()
actualizarTemporada(3, 7)
